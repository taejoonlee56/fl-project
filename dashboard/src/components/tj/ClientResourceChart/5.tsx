...
const ClientResourceChart: React.FC = () => {
  const [state, setState] = React.useState({
    series: [
      {
        name: 'Client-1',
        data: [36.25,45,40.24,42,34.15],
      },
      {
        name: 'Client-2',
        data: [48.8,20.45,20.05,20.4,13.65],
      },
      {
        name: 'Client-3',
        data: [34.55,51.7,31.7,32.25,63],
      },
      {
        name: 'Client-4',
        data: [32.55,22.65,26.6,38.6,22.05],
      },
      {
        name: 'Client-5',
        data: [13.3,13.75,13.65,13.24,21.3],
      },
      // {
      //   name: 'Client-1',
      //   data: [0,36.25,45,89],
