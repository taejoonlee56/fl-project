    ...
    xAxis: [
      {
        type: 'category',
        boundaryGap: false,
        data: ['1-Round', '2-Round', '3-Round', '4-Round', '5-Round'],
        axisLabel: {
    ...
    series: [
      {
        ...
        // 클라이언트1의 누적량
        data: [50.00052778,50.49245086,51.0643287,51.67602314,52.28877314],
      },
      {
        name: t('Client-2'),
        type: 'line',
        ...
        data: [50.00077778,50.78477778,51.65972342,52.51743647,53.38217006],
      },
      {
        name: t('Client-3'),
        type: 'line',
        ...
        data: [50.00213889,52.12429712,54.62038046,57.05464508,59.50050683],
      },
      {
        name: t('Client-4'),
        type: 'line',
        ...
        data: [50.00319444,53.19402926,56.88271226,60.58507337,64.29382337],
      },
      {
        name: t('Client-5'),
        type: 'line',
        ...
        data: [50,83.56523503,100,100,100],
      },
    ],
  };
